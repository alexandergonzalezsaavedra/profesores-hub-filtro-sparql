...
const Formulario = ({ setFiltroProfesor, profesores }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-1 container">
      <div className="row d-flex justify-content-center">
        ...
        <div className="col-sm-3">
          <button className="btn btn-outline-primary me-2">Buscar</button>
          <button onClick={limpiarFiltro} className="btn btn-outline-danger">
            Limpiar filtro
          </button>
        </div>
      </div>
